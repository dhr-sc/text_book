...
##  Dimensions (range):  
##      time: (2014-11-02T12:00:00Z, 2020-01-16T12:00:00Z) 
##      altitude: (0.0, 0.0) 
...
p + geom_point() + 
  ...
  scale_color_gradientn(colours = cmocean('dense')(12), name="Buoy\nLatitude") +
...
## -3.4964 -0.4086  0.0312  0.4499  2.3933 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 0.955247   0.139463   6.849 2.97e-11 ***
## sst         0.951597   0.006893 138.059  < 2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.6998 on 383 degrees of freedom
## Multiple R-squared:  0.9803,	Adjusted R-squared:  0.9803 
## F-statistic: 1.906e+04 on 1 and 383 DF,  p-value: < 2.2e-16
```
...
myplot<-ggplot(data = sstFrame, aes(x = x, y = y, fill = sst)) +
  ...
  scale_fill_gradientn(colours = cmocean('thermal')(12),limits=c(10,25),na.value = NA) +
  ...
  scale_color_gradientn(colours = cmocean('thermal')(12),limits=c(10,25),na.value ="grey20", guide=FALSE) 
