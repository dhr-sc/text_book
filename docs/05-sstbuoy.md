...
##  Dimensions (range):  
##      time: (2014-11-02T12:00:00Z, 2019-04-21T12:00:00Z) 
##      altitude: (0.0, 0.0) 
...
<img src="05-sstbuoy_files/figure-html/xyplot-1.png" width="672" />
...
## -3.5024 -0.4054  0.0292  0.4481  2.3929 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept) 0.975403   0.136551   7.143 4.56e-12 ***
## sst         0.950711   0.006773 140.368  < 2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.6968 on 387 degrees of freedom
## Multiple R-squared:  0.9807,	Adjusted R-squared:  0.9807 
## F-statistic: 1.97e+04 on 1 and 387 DF,  p-value: < 2.2e-16
```
...
<img src="05-sstbuoy_files/figure-html/map-1.png" width="672" />
